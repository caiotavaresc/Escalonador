...
public class Escalonador {
    ...
    //Metodo que carrega os processos na memï¿½ria
    public static void carregaProcessos() throws IOException {
        ...
        File[] arquivos;
        //Caminho onde estï¿½o os arquivos do processo, prioridades e quantum
        File diretorio;
        //Arquivo do quantum
        //Isso do null foi o Java que fez, se alguï¿½m tiver algo mais bonito...
        File quantum = null;
        ...
        for (int i = 0; i <= arquivos.length - 1; i++) {
            ...
            if (arquivos[i].getName().equals("quantum.txt")|| arquivos[i].getName().equals("prioridades.txt")) {
                //Informacoes ja carregadas
                    ...
                    //Carregar os processos em memï¿½ria, um a um
                    myReader = new FileReader(arquivos[i]);
                    myBuffer = new BufferedReader(myReader);

                    //A primeira linha ï¿½ o tï¿½tulo do processo
                    ...
                    //Carregar todas as instruï¿½ï¿½es na memï¿½ria
                    while ((texto = myBuffer.readLine()) != null) {
                        //1 - Colocar o texto na memï¿½ria
                    ...
                    //Limpar instruï¿½ï¿½es e fechar o buffer
                    instrucoes.clear();
                    myBuffer.close();
                }
    ...
    public static void escalonar() throws IOException {
        ...
        if (i.hasNext()) {
            ...
            //Pegar o primeiro da fila, se ela nï¿½o estiver vazia
            prox = i.next();
            ...
            for (indQuantum = 0; indQuantum < _quantum; indQuantum++) {
                ...
                try {
                    ...
                    if (e.getMessage().equals("E")) {
                        ...
                        //Tirar o processo da fila de prontos e pï¿½r na fila de bloqueados
